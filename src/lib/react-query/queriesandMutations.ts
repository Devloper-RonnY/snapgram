import {useQuery, useQueryClient, useMutation, useInfiniteQuery, Query} from "@tanstack/react-query";
...
export const useCreatePost = () => {
  ...
  return useMutation({
    mutationFn: (post: INewPost) => createPost(post), // This function must exist
    onSuccess: () => {
